        ...
        >
            ...
            <div className="row-span-2 grid grid-rows-2">
                <div className="row-span-1 grid grid-cols-10">
                    ...
                    <div className="col-span-3 flex items-center justify-end text-textColor-1 mr-1">{data?.stockAmount.toLocaleString()}개</div>
                </div>
                <div className="row-span-1 grid grid-cols-10">
                    ...
                    <div className="col-span-3 flex items-center justify-end text-textColor-1 mr-1">{data?.averagePurchasePrice.toLocaleString()}원</div>
                </div>
            </div>
        </div>
    );
